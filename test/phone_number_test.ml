...
let tests =
  [
    "cleans the number" >:: ae (Ok "2234567890") (number "(223) 456-7890");
    "cleans numbers with dots" >:: ae (Ok "2234567890") (number "223.456.7890");
    ...
    >:: ae (Error "exchange code cannot start with zero")
          (number "(223) 056-7890");
    "invalid if exchange code starts with 1"
    >:: ae (Error "exchange code cannot start with one")
          (number "(223) 156-7890");
    "invalid if area code starts with 0 on valid 11-digit number"
    >:: ae (Error "area code cannot start with zero")
...
let run_test () = run_test_tt_main ("phone-number tests" >::: tests)
