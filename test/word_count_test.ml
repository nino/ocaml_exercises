...
let tests =
  [
    "count one word" >:: ae [ ("word", 1) ] (word_count "word");
    ...
    >:: ae [ ("one", 1); ("two", 1); ("three", 1) ] (word_count "one,two,three");
    ...
    "normalize case"
    >:: ae [ ("go", 3); ("stop", 2) ] (word_count "go Go GO Stop stop");
    "with apostrophes"
    >:: ae
...
let run_test () = run_test_tt_main ("word_count tests" >::: tests)
